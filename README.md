...
- Flashes the entire key between high-visibility red and yellow for 10 seconds after a response completes, then shows the elapsed update time on a static red completion display until you physically press the corresponding task or summary key
